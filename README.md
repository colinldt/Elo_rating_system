...
![1-(x/2^100 )/(2^(x/100)+2^(y/100) )](adjusted_formula.png)
...
![K(1-(x/2^100 )/(2^(x/100)+2^(y/100) ))](formula_K.png)
...
![adaptative_K_chart](adaptative_K_chart.png)